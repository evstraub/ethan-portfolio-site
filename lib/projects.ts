const projects = [
  { title: 'Spanish Flashcards', slug: 'spanish-flashcards', summary: 'Spaced repetition flashcards with local storage and charts.', tags: ['React'] },
  { title: 'Word-Search Solver', slug: 'word-search-solver', summary: 'C++ CLI solver with tests and benchmarks.', tags: ['C++'] },
